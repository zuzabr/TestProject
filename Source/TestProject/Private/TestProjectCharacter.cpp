...
ATestProjectCharacter::ATestProjectCharacter()
{
    ...
    ViewCollision = CreateDefaultSubobject<UBoxComponent>("View Collision");
    ViewCollision->SetupAttachment(FollowCamera);
...
void ATestProjectCharacter::SetupPlayerInputComponent(class UInputComponent* PlayerInputComponent)
{
    ...
    PlayerInputComponent->BindAction("Interact", IE_Released, this, &ATestProjectCharacter::Interact);
...
void ATestProjectCharacter::BeginPlay() 
{
    ...
    if (ViewCollision)
    {
        ViewCollision->OnComponentBeginOverlap.AddDynamic(this, &ATestProjectCharacter::FindObject);
        ViewCollision->OnComponentEndOverlap.AddDynamic(this, &ATestProjectCharacter::LoseObject);
    }

    UActorsCounterNativeFunctionLibrary::CountActorsOnLevel(this);
...
void ATestProjectCharacter::Tick(float DeltaTime)
{
    ...
    if (IInteractionInterface* Interface = Cast<IInteractionInterface>(Hit.GetActor()))
    {
        Interface->Interact();
    }*/
}

 void ATestProjectCharacter::Interact() 
 {
 ...
 void ATestProjectCharacter::FindObject(UPrimitiveComponent* OverlappedComponent, AActor* OtherActor, UPrimitiveComponent* OtherComp,
     int32 OtherBodyIndex, bool bFromSweep, const FHitResult& SweepResult)
 {
    OtherComp->SetRenderCustomDepth(true);
 }

 void ATestProjectCharacter::LoseObject(
